...
export function render404(element) {
  const NoutFoundTemplateFn =  loadTemplate("/partials/404.html");
    return renderWithTemplate(NoutFoundTemplateFn, element)
}
...
export function updateCartIcon() {
  let cartCounter = document.querySelector("#cart-amt")
